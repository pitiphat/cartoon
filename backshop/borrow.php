...
?>
    ...
    <form class="form-horizontal" action="method/checkBorrow.php" method="POST">
            <div class="control-group">
              <label class="control-label">รหัสสมาชิก <strong class="text-error" style="font-size: 20px">*</strong></label>
              <div class="controls">
                <input name="memId" type="text" maxlength="8" required/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                    <div id="field">
                          <input class="input" id="field1" name="field[]" type="text"
            ...
            <div class="control-group">
              <div class="controls">
                <button type="submit" name="btnCheckBorrow" class="btn btn-warning">ตรวจสอบ</button>
              </div>
            </div>
     </form>
