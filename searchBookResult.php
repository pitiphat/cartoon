    ...
    if(isset($_GET['btn_Search'])){
        if($_GET['selectBook']=="book"){
            $sql = "select b.Book_Id, a.Book_Name, b.Vol, a.Rent_Price, b.Book_Status, a.Date_Quantity 
                    ...
                    and (b.Book_Status='True' or b.Book_Status='False')
...
HTMLBLOCK;
			while($array=mysqli_fetch_array($result)){
                            if($array['Book_Status'] == 'True'){
                                $array['Book_Status']='ยืมได้';
                            }
                            else{
                                $array['Book_Status']='ถูกยืมไปแล้ว';
                            }
                            echo <<<HTMLBLOCK
                            ...
                            <td><a href="#" onClick="window.open('test.php?re={$array['Book_Id']}','','width=500,height=560');">ดูข้อมูล</a></td>
                            </tr>
